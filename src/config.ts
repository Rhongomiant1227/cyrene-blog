...
const DEFAULT_SITE_URL = "https://rhongomiant1227.github.io/cyrene-blog/";
...
export const siteConfig: SiteConfig = {
	title: "昔涟 Cyrene",
	subtitle: "围绕官方昔涟素材重构的静态主题博客",
	siteURL: process.env.PUBLIC_SITE_URL || DEFAULT_SITE_URL, // 部署到正式域名后请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-05-10", // 站点开始运行日期，用于站点统计组件计算运行天数
	keywords: [
		"昔涟",
		"Cyrene",
		"崩坏星穹铁道",
	...
	themeColor: {
		hue: 308, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	navbarTitle: {
		...
		icon: "/assets/cyrene/stickers/cyrene-sticker-glance-back.png",
		// 网站Logo图片路径
		logo: "/assets/cyrene/official/profile-keeping-promise.png",
	},
	...
	banner: {
		...
		src: {
			desktop: "/assets/cyrene/derived/hero-desktop.webp", // 桌面横幅图片
			mobile: "/assets/cyrene/derived/hero-mobile.webp", // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			subtitle: "以官方立绘、活动横幅与 Q 版贴纸重构的昔涟主题静态博客。",
			typewriter: {
				enable: false, // 启用副标题打字机效果

				speed: 55, // 打字速度（毫秒）
				deleteSpeed: 25, // 删除速度（毫秒）
				pauseTime: 2600, // 完全显示后的暂停时间（毫秒）
			},
		},
		...
		credit: {
			...
			text: "Official Cyrene assets", // 要显示的来源文本
			url: "https://honkai-star-rail.fandom.com/wiki/Cyrene/Media", // （可选）原始艺术品或艺术家页面的 URL 链接
		},
	...
	font: {
		...
		// 注意：字体子集优化功能目前仅支持 TTF 格式字体。开发环境直接加载原始字体文件，生产环境会额外生成压缩后的字体资源。
		asciiFont: {
			// 英文字体 - 优先级最高
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	src: {
		desktop: [
			"/assets/cyrene/official/splash-screen-ripples-rejoined.png",
			"/assets/cyrene/official/splash-screen-as-tomorrow-became-yesterday.png",
		], // 桌面横幅图片
		mobile: [
			"/assets/cyrene/derived/hero-mobile.webp",
			"/assets/cyrene/official/phone-case.png",
		], // 移动横幅图片
	}, // 使用本地横幅图片
	...
	links: [
		...
		LinkPreset.About,
		{
			...
			children: [
				{
					name: "角色资料",
					url: "https://honkai-star-rail.fandom.com/wiki/Cyrene",
					external: true,
					icon: "material-symbols:person-search-rounded",
				},
				{
					name: "角色图库",
					url: "https://honkai-star-rail.fandom.com/wiki/Cyrene/Media",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "/assets/cyrene/official/profile-keeping-promise.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "昔涟 / Cyrene",
	bio: "以官方立绘、活动横幅、头像和 Q 版贴纸为主参考，重构一套柔亮而克制的角色主题界面。",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	title: "主题说明", // 公告标题，填空使用i18n字符串Key.announcement
	content:
		"当前预览版优先使用项目内置的官方昔涟素材：立绘、活动横幅、头像、手机壳、光锥图和五张 Q 版贴纸。", // 公告内容
